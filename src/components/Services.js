...
import Textservices from "./helpers/Textservices";
            ...
            <div className="row">
              <div className="col-md-6 ">
                ...
                <ul className="list">
                  ...
                  <Fade bottom cascade>
                    <li>
                      <span>{this.props.t("services.text1a")}</span>
                    </li>
                    <li>
                      <span>{this.props.t("services.text1b")}</span>
                    </li>
                    <li>
                      <span>{this.props.t("services.text1c")}</span>
                    </li>
                    <li>
                      <span>{this.props.t("services.text1d")}</span>
                    </li>
                    <li>
                      <span>{this.props.t("services.text1e")}</span>
                    </li>
                    <li>
                      <span>{this.props.t("services.text1f")}</span>
                    </li>
                    <li>
                      <span>{this.props.t("services.text1g")}</span>
                    </li>

                    <li>
                      <span>{this.props.t("services.text1h")}</span>
                    </li>

                    <li>
                      <span>{this.props.t("services.text1i")}</span>
                    </li>
                  </Fade>
                </ul>
              </div>
                ...
                <Reveal effect="fadeInUp">
                  <Swiper {...params}>
                    {this.state.items.map(item => (
                      <div key={item.id}>
                        <img src={item.img} alt="catering di arabella" />
                      </div>
                    ))}
                  </Swiper>{" "}
                </Reveal>
                    ...
                    <div className="gallery gallery1">
                      <Fade left cascade>
                        <div className="gallery-title">
                          CANNELLONI IN VERTICALE
                        </div>

                        <div className="gallery-subtitle">
                          con ripieno di noce tostate, spinaci, ricotta fresa e
                          salsa di pomodori
                        </div>
                        <NavLink className="link4" to="/gallery">
                          Show more
                        </NavLink>
                      </Fade>
                    </div>
          ...
          <div className="container-fluid bottom">
            <div className="row ">
              ...
              <div className="col-md-3 offset-md-1 offset-2 col-8">
                <Reveal effect="fadeInUp">
                  <img src={h16} alt="catering di arabella" />
                </Reveal>
              </div>
            </div>
          </div>
          <div className="container-fluid bottom">
            <div className="row ">
              ...
              <div className="col-md-4">
                <div className="midd">
                  <p className="">{this.props.t("services.text4")}</p>{" "}
                </div>
              ...
              <div className="col-md-5 offset-md-1 col-lg-4 offset-lg-1 padding-top140">
                <div className="seal">
                  <Reveal effect="fadeInUp">
                    <img src={seal} alt="catering di arabella" />
                  </Reveal>
                </div>
                <ul className="list1">
                  <h2>Quality Services & Quality Guarantee:</h2>
                  <li>
                    <span>{this.props.t("services.text6")}</span>
                  </li>

                  <li>
                    <span>{this.props.t("services.text7")}</span>
                  </li>
                  <li>
                    <span>{this.props.t("services.text8")}</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="col-md-2 offset-md-2 col-10 offset-1">
                <Reveal effect="fadeInUp">
                  ...
                  <ImageZoom
                    image={{
                      src:
                        "http://cateringdiarabella.com/img/cateringdiarabella_2th.jpg",
                    ...
                    zoomImage={{
                      src:
                        "http://cateringdiarabella.com/img/cateringdiarabella_2.jpg",
                      alt: "Catering di Arabella"
                    }}
                  />
                </Reveal>
