          ...
          <div className="container-fluid bottom">
            <div className="row">
              ...
              <div className="col-md-4 offset-md-1  padding-top">
                <Fade bottom delay={200}>
                  <p className="extra">{this.props.t("about.text2")}</p>
                </Fade>
              </div>
            </div>
          </div>
                    ...
                    <div className="gallery gallery1">
                      <Fade left cascade>
                        ...
                        <div className="gallery-subtitle">
                          al cocco, con scaglie di cocco e fiori eduli
                        </div>
              ...
              <div className="col-md-2 offset-md-7 offset-2 col-8">
                <Reveal effect="fadeInUp">
                  ...
                  <ImageZoom
                    image={{
                      src:
                        "http://cateringdiarabella.com/img/cateringdiarabella_1th.jpg",
                      alt: "Catering di Arabella",
                      className: "",
                      style: { width: "" }
                    }}
                    zoomImage={{
                      src:
                        "http://cateringdiarabella.com/img/cateringdiarabella_1.jpg",
                      alt: "Catering di Arabella"
                    }}
                  />
                </Reveal>
              ...
              <div className="col-md-8 offset-md-2  bottom bg-grey">
                <div className="sobre">
                  <p className="txt-sobre">
                    <span>Arabela Della Casa</span>
                    {this.props.t("about.text3a")}
                  </p>
